 ...
 * Modified by the RevBridge contributors in 2026 for current Android releases.
...
public class GnirehtetActivity extends Activity {
    ...
    public static final String ACTION_GNIREHTET_START = "io.github.innocent254.revbridge.START";
    public static final String ACTION_GNIREHTET_STOP = "io.github.innocent254.revbridge.STOP";
